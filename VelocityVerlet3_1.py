...
#initial celestial bodies positions - TAKEN AT 10/31/2017 12:00 AM
...
venus = Celestial(venusmass, -7.15*10**-1, 5.07*10**-2, 4.19*10**-2, -1.38*10**-3, -2.03*10**-2, -1.99*10**-4, 0.1)
